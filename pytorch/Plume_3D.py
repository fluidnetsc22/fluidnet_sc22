...
# Cylinder Test
parser.add_argument('-c', '--Cylinder',
                    default=True,
...
if not arguments.Cylinder:
    ...
    Cylinder_string = arguments.Cylinder
    if Cylinder_string == 'True' or Cylinder_string == 'true':
        Cylinder = True
    else:
        Cylinder = False
...
for network in simConf['study_nets']:
    ...
    try:
        ...
        with torch.no_grad():
            ...
            centerX = simConf['centerX']
            centerY = simConf['centerY']
            centerZ = simConf['centerZ']
            radCyl = simConf['radius']
