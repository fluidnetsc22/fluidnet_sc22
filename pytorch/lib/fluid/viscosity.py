...
def addViscosity(dt, U, flags, viscosity):
    ...
    if not is3D:
        ...
        U[:, :, 1:(d - 1), 1:(h - 1), 1:(w - 1)] = mask * (
            U.narrow(4, 1, w - 2).narrow(3, 1, h - 2).narrow(2, 1, d - 2) +
            dt * viscosity * vis_mask * (
                U.narrow(4, 2, w - 2).narrow(3, 1, h - 2).narrow(2, 1, d - 2) +
                U.narrow(4, 1, w - 2).narrow(3, 2, h - 2).narrow(2, 1, d - 2) +
                U.narrow(4, 0, w - 2).narrow(3, 1, h - 2).narrow(2, 1, d - 2) +
                U.narrow(4, 1, w - 2).narrow(3, 0, h - 2).narrow(2, 1, d - 2) +
                U.narrow(4, 1, w - 2).narrow(3, 1, h - 2).narrow(2, 0, d - 2) +
                U.narrow(4, 1, w - 2).narrow(3, 1, h - 2).narrow(2, 2, d - 2) -
                (6 * U.narrow(4, 1, w - 2).narrow(3, 1, h - 2).narrow(2, 1, d - 2))
            ))
